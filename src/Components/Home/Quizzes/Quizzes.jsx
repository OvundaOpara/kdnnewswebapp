  ...
  return (
    ...
    {QZ.map((item, index) => (
      <div className='flex flex-col w-[400px] h-[400px] items-center justify-center lg:w-[31%] border-[2px] border-stone-500 px-3 py-3 rounded-xl '>
        ...
        <p className='text-lg text-center  my-4 text-stone-400'>{item.title}</p>
    
        <div className="flex gap-5 w-full items-center justify-center   ">
            <button className='bg-[#CF0807] py-2 w-[90%] text-stone-300 text-lg rounded-md '>Start Quiz </button>
