    ...
    <div className='px-[60px] my-24'>
      <Slider {...settings} className='flex items-center justify-center '>
        {ADS.map((ads, index) => (
          <div
            key={index}
            className='flex flex-wrap   h-[400px] items-center justify-center rounded-xl w-[400px] lg:w-[100%]'
          >
            <div className='flex w-full items-center justify-center  rounded-xl h-[400px]  bg-gradient-to-r  to-buttonsColor from-black via-black' >
