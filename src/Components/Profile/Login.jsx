      ...
      <div className='bg-black text-white p-8 rounded-lg w-full  shadow-lg overflow-scroll  max-w-xl'>
        ...
        <div className='mb-6 space-y-2  '>
          <div className='flex flex-col items-center justify-between'>
            ...
            <button onClick={onClose} className='text-stone-300 duration-300 mb-5 bg-[#CF0807] hover:bg-[#EF5454] py-2 w-full rounded-3xl'>Login</button>
            ...
            <p className='gap-2'>Don't have an Account  <Link onClick={onSwitchToRegister} className='text-[#CF0807] font-extrabold'>Sign Up</Link></p>
          </div>
        </div>
      </div>
    </div>
