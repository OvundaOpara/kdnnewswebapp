    ...
    <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3  items-center justify-center gap-12 mt-[10px] '>
      <div className='flex flex-col lg:w-[100%] w-[100%] gap-3  '>
        <div className='flex flex-col  rounded-xl group '>
          <div className='flex bg-stone-600 h-[130px] items-center justify-center rounded-xl w-full transform scale-y-100 transition-transform duration-300 ease-out group-hover:scale-y-[1.8] origin-top'></div>
      ...
      <div className='flex flex-col items-start h-[60vh] group lg:w-[100%] w-[100%]  '>
        <div className='flex flex-col items-start h-full gap-5 rounded-xl w-full '>
          <div className='flex bg-stone-600 h-[250px] items-center justify-center rounded-xl w-full transform scale-y-100 transition-transform duration-300 ease-out group-hover:scale-y-[1.9] origin-top'></div>
